  ...
  return (
    <div className="min-h-screen bg-warm-50 flex items-center justify-center p-6">
      ...
      >
        ...
        {/* Card */}
        <div className="bg-white border border-warm-200 rounded-xl shadow-sm p-8 text-center">
          ...
          <h2 className="text-2xl font-bold text-warm-900 mb-3">Verify Your Email</h2>
          ...
          <p className="text-warm-500 text-sm mb-6 leading-relaxed">
            Please check your inbox and click the verification link to activate your MindWell account. 
          ...
          <div className="space-y-3">
            ...
            <Link to="/signup" className="block text-center text-primary-600 hover:text-primary-700 font-medium text-sm">
